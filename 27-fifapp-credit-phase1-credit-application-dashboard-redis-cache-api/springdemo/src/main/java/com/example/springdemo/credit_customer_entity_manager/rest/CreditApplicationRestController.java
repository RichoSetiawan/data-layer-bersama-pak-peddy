...
public class CreditApplicationRestController {
    ...
    @GetMapping("/credit-applications/new")
    public List<CreditApplicationResponse> getAllCreditNew(){
        return creditApplicationService.findAllWithCustomerAndVehicle();
    }

    @GetMapping("/credit-applications/status/new")
    public List<CreditApplicationResponse> getByStatusNew(@RequestParam(required = false) String status){
        return creditApplicationService.findByStatusWithCustomerAndVehicle(status);
    }

    @GetMapping("/credit-applications/dashboard")
